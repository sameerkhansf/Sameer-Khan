      ...
      <div className="min-h-screen bg-background text-foreground">
        <div className="container max-w-lg mx-auto px-4 py-12">
          ...
          <main id="main-content" className="space-y-8">
            <IntroSection translations={dict.intro} lang={lang} />
          </main>
            ...
            <div className="flex flex-col items-center space-y-4 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <Link
                  ...
                  aria-label={`${dict.social.followOn} X (Twitter)`}
                >
                  @sameerkhansf
                </Link>
                <span>·</span>
                <Link
                  ...
                  target="_blank"
                  className="hover:text-blue-600 hover:decoration-wavy hover:underline"
                  aria-label={`${dict.social.connectOn} LinkedIn`}
                >
                  linkedin
                </Link>
                <span>·</span>
                <Link
                  ...
                  target="_blank"
                  className="hover:text-blue-600 hover:decoration-wavy hover:underline"
                  aria-label={`${dict.social.viewProjects} GitHub`}
                >
                  github
                </Link>
              </div>
