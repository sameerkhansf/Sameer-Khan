---
title: "Tiel Coder 35B Review: Specialized Coding Model Beats Opus 4.6 on SWE-Bench Live"
...
# Tiel Coder 35B Review: Specialized Coding Model Beats Opus 4.6 on SWE-Bench Live
...
| Opus 4.6 Medium | Complex reasoning, refactoring | 12/25 (48%) | ~65 | API only | Usage-based |
| Nail Qwen3.6-35B | Exam knowledge, hard reasoning | ~8/25 | ~60.5 | ~18 GB (Q4) | Free (local) |
| Dirk Qwen3.8-27B | Most fixes regardless of weight | 15/25 (60%) | Lower | ~27 GB | Free (local) |
| Stock Qwen3.6-35B-A3B | Baseline comparison | 8/25 (32%) | ~65.3 | ~18 GB | Free (local) |
...
- Context KV memory: <5 GB RAM for 262k context at 16-bit KV precision
