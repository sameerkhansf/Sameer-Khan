...
const navItems = [
  {
    ...
    label: "Intro",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" className="text-gray-600 dark:text-gray-300">
    ...
    <div className="mb-8">
        ...
        {navItems.map((item) => (
          <a
            ...
            className={`flex items-center justify-center w-10 h-10 transition-all duration-200 opacity-40 hover:opacity-100 ${
